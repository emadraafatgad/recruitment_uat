...
class ControllerREST(http.Controller):
    ...
    @check_permissions
    def api__res_partner__POST(self, **kw):
    ...
    @check_permissions
    def api__res_partner__id_PUT(self, id, **kw):
    ...
    @check_permissions
    def api__res_partner__id_DELETE(self, id, **kw):
    ...
    @check_permissions
    def api__res_partner__id__method_PUT(self, id, method, **kw):
