...
class ControllerREST(http.Controller):
    ...
    @check_permissions
    def api__product_template__POST(self, **kw):
    ...
    @check_permissions
    def api__product_template__id_PUT(self, id, **kw):
    ...
    @check_permissions
    def api__product_template__id_DELETE(self, id, **kw):
    ...
    @check_permissions
    def api__product_template__id__method_PUT(self, id, method, **kw):
