...
class OperationOrder(models.Model):
    ...
    shipment_plan = fields.Many2one('delivery.plan', required=True)
    ...
    product = fields.Many2one('product.product', required=True, string='Commodity')
...
class OperationOrderInvoice(models.Model):
    ...
    def action_invoice_open(self):
        ...
        return super(OperationOrderInvoice, self).action_invoice_open()
