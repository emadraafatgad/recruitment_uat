...
class ControllerREST(http.Controller):
    ...
    @check_permissions
    def api__account_invoice_line__POST(self, **kw):
    ...
    @check_permissions
    def api__account_invoice_line__id_PUT(self, id, **kw):
    ...
    @check_permissions
    def api__account_invoice_line__id_DELETE(self, id, **kw):
    ...
    @check_permissions
    def api__account_invoice_line__id__method_PUT(self, id, method, **kw):
